            ...
            <div class="col-lg-12 col-md-12">
                <div class="login_part_form text-center">
                    <div class="login_part_form_iner">
                        <h3>Create Your shop profile</h3>
                        <form class="row contact_form" action="#" method="post">
                            ...
                            <div class="col-md-12 form-group p_star">
                                <input type="text" class="form-control"  name="shop_category" placeholder="Shop Category" required>
                            </div>
                            <div class="col-md-12 form-group p_star">
                                <textarea class="form-control"  name="shop_description" placeholder="Shop Description" required></textarea>
                            </div>
